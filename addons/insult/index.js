...
module.exports = function(bot, callback) {
	var words = {
		...
		food_action_passive : [
			...
			"ins Bett legen",
			"zu Fressen geben",
			"su tief in den Arsch stecken, dass es aus dem Mund wieder rauskommt",
			"zeigen",
			"verderben",
			"in die Haare schmieren",
			"über den ganzen Körper reiben",
			"so richtig schmackhaft machen",
			"in die Socken stecken",
			"in den Auspuff stecken",
			"an den Rücken kleben",
			"in die Tasche stecken",
			"in einem Briefumschlag zuschicken",
			"bei eBay bestellen",
			"auf die Stirn tattowieren",
			"in die Achselhaare knoten",
			"an den Sack tackern",
			"zwischen die Zehnägel packen",
			"in den Po stecken",
			"in die Arschritze klemmen",
			"in den Briefkasten stopfen",
			"pürrieren",
			"in den Bauchnabel stecken",
			"an den Schwanz nageln",
			"in den Rachen stecken",
			"auf die Arschbacken schmieren",
			"faxen",
			"zur künstlichen Befruchtung vorbereiten",
			"links ins Ohr stecken, bis es rechts wieder rauskommt"
		],
		verb : [
			"Sterben",
			"Kacken",
	...
	var unspecificSentences = [
		...
		'Yo, {{attribute}}{{subject}}. Geh {{genitals}} {{genital_action_hurt}}n.',
		'Hey, {{attribute}}{{subject}}! Du bist {{attribute}}.',
		'Zeig mir deine Mutter und ich {{genital_action_hurt}} ihr in die {{genitals}}.',
		'{{genital_action}} meine {{genitals}}, {{attribute}}{{subject}}.',
		'Soll ich dir mal so richtig in die {{genitals}} {{genital_action_hurt}}n?',
		'Dir muss wohl dringend mal jemand die {{genitals}} {{genital_action}}n, {{attribute}}{{subject}}!',
		'{{genital_action}} dir die {{genitals}} und dann {{genital_action_hurt}} ich dir die {{genitals}}.',
		'Oh ja, ich {{genital_action_hurt}} dir die {{genitals}}. Das macht dich ganz {{attribute}}, {{attribute}}{{subject}}!'
	];
	...
	specificSentences = [
		...
		'Yo, {{ziel}}, du {{attribute}}{{subject}}. Geh {{genitals}} {{genital_action_hurt}}n.',
		'Hey, {{ziel}}, du {{attribute}}{{subject}}! Du bist {{attribute}}.',
		'{{ziel}}! Zeig mir deine Mutter und ich {{genital_action_hurt}} ihr in die {{genitals}}.',
		'{{genital_action}} meine {{genitals}}, {{attribute}}{{subject}}. Da stehst du doch drauf, {{ziel}}',
		'Soll ich {{ziel}} mal so richtig in die {{genitals}} {{genital_action_hurt}}n?',
		'{{ziel}} muss dringend mal jemand die {{genitals}} {{genital_action}}n, {{attribute}}{{subject}}!',
		'{{genital_action}} dir die {{genitals}} und dann {{genital_action_hurt}} ich dir die {{genitals}}, {{ziel}}!'
	];
